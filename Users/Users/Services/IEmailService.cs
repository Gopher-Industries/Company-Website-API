...
namespace Users.Services
{
    public interface IEmailService
    {
        ...
        public Task SendConfirmationEmail(IGopherUser User);
    ...
    public class SendGridService : IEmailService
    {
        ...
        public async Task SendConfirmationEmail(IGopherUser User)
        {
            ...
            var apiKey = "SG.ZriV9---------------"; // Environment.GetEnvironmentVariable("SENDGRID_API_KEY");
        ...
        /// <returns></returns>
        public async Task SendConfirmationEmailOld(IGopherUser User)
        {
            try
            {
